...
/***/ function(module, exports) {
	...
	var question_counter = state.question_counter;
	var correct = state.correct;
	var questionHTML = state.questionHTML;
	...
	var addItem = function addItem(state, question) {
	    items.push(question);
	};
	
	var getNextQuestion = function getNextQuestion(state, element) {
	...
	var renderAnswers = function renderAnswers(state, element) {
	    var answersHTML = answers.map(function (answer) {
	...
	var checkAnswer = function checkAnswer(state, chosenAnswer) {
	...
	function populateItems() {
	    $.each(questions, function (index, question) {
	        return addItem(state, question);
	    });
	}
	var resetState = function resetState(state, element, element2) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=quizz-app-remake.1.0.0.js.map